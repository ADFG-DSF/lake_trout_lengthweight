...
# nmat1 <- nmat
nmat1$n_Length[nmat1$Use_Samples=="No"] <- "-"
nmat1$n_Weight[nmat1$Use_Samples=="No"] <- "-"
nmat1$n_Age[nmat1$Use_Samples=="No"] <- "-"
...
nmat1est <- subset(nmat1, Estimate_Winf=="Yes")
nmat1supp <- subset(nmat1, Estimate_Winf=="No")

colnames(nmat1est) <- colnames(nmat1supp) <- 
  c("Lake", 
                     "Estimate $W_{\\infty}$",
                     "Use Samples",
                     "n Projects",
