...
$$ln(\hat{YP_{kg}}) = bb0 + bb1 ln(A)$$

in which $\hag{YP_{kg}} represents the yield potential expressed in kilograms biomass, and *A* represents lake area measured in hectares.
...
^^^ this paragraph maybe is better in methods?
