...
int_Winf_data <- list(Age = laketrout$Age,
...
# int_Winf_data$max_nL <- max(int_Winf_data$which_nL, na.rm=TRUE)
# int_Winf_data$max_nW <- max(int_Winf_data$which_nW, na.rm=TRUE)

# int_Winf_data$whichlakes_L <- int_Winf_data$whichlakes_L[int_Winf_data$whichlakes_L != 5]
...
# save(int_Winf_jags_out, file="modelpost_3_4_25.Rdata")
